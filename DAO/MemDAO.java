...
public class MemDAO extends SuperDAO implements DAOinf<MemDTO> {
    ...
    public boolean idPassDuplicate(int num, String id, String pw) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "db 회원 검사 쿼리 오류", "Warning", JOptionPane.WARNING_MESSAGE);
            throw new RuntimeException(e);
        } finally {
            try {
                conn.close();
    ...
    public boolean idDuplicate(String id) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "db 회원 id 검사 쿼리 오류", "Warning", JOptionPane.WARNING_MESSAGE);
            throw new RuntimeException(e);
        } finally {
            try {
                conn.close();
