...
public class Client2 {
	...
	public static void main(String[] args) {
		Runnable a2=new ProtocolClient2(9500,"id");
...
class ProtocolClient2 extends JFrame implements Runnable, ActionListener {
	...
	public ProtocolClient2(int port,String id) {
		this.port=port;
		this.id=id;
	...
	public void run() {
		try {
			...
			writer.println("manager");  //서버로 데이터를 전송한다. 
			writer.flush();   //버퍼 안에 있는 값들을 전부 비워준다. 
			System.out.println("데이터 전송 완료!");
