...
//        아래 위로 빈칸 넣기
    ...
    public void delete() {
        ...
        if (index < 0) {
            ...
            //db도 지워준다.
            timeTableDAO.deleteT(timeTableDTOList.get(index).getTiId());
            ...
            switch (columnIndex) {
                case 1:
                    ...
                    newTimeTableDTO = TimeTableDTO.builder()
                            ...
                            .build();
                    timeTableDAO.updateT(newTimeTableDTO,id2);
                    break;
                case 2:
                    Time value2 = null;
                    try {
                    ...
                    newTimeTableDTO = TimeTableDTO.builder()
                            ...
                            .tiContent(timeTableDTOList.get(rowIndex).getTiContent())
                            .build();
                    timeTableDAO.updateT(newTimeTableDTO,id3);
                    break;
                case 3:
                    ...
                    newTimeTableDTO = TimeTableDTO.builder()
                            ...
                            .tiContent(value)
                            .build();
                    timeTableDAO.updateT(newTimeTableDTO,id4);
                    break;
            }
        }
